      ...
      <div className="relative z-10 container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="stagger space-y-6">
            {contactInfo.map((info) => {
              ...
              return (
                <Wrapper
                  ...
                  className="fade-in-up flex items-center gap-5 glass-premium glowing-card rounded-2xl p-6 hover:scale-[1.02] cursor-pointer"
                >
                  <div className="w-14 h-14 rounded-2xl bg-indigo-500/10 flex items-center justify-center text-indigo-400 group-hover:bg-indigo-500/20 group-hover:scale-110 transition-all duration-300 shadow-inner">
                    {info.icon}
                  </div>
                  <div>
                    <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">{info.label}</p>
                    <p className="text-white font-semibold text-base sm:text-lg tracking-wide">{info.value}</p>
                  </div>
                </Wrapper>
              );
            })}
            ...
            {/* Social links */}
            <div className="fade-in-up flex items-center gap-4 pt-6">
              <a
                href="https://github.com/VINAYLAKAMANAHALLI"
                target="_blank"
                rel="noopener noreferrer"
                className="p-4 rounded-xl glass-premium text-gray-400 hover:text-white hover:border-indigo-500/40 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-300 hover:scale-110"
                aria-label="GitHub"
              >
          ...
          {/* Contact form */}
          <form onSubmit={handleSubmit} className="fade-in-up glass-premium glowing-card rounded-2xl p-8 sm:p-10 space-y-6">
            <div>
            ...
            <button type="submit" id="send-message-btn" className="group w-full py-4 rounded-xl font-bold text-white bg-gradient-to-r from-indigo-500 to-cyan-500 shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 hover:scale-[1.01] active:scale-99 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer">
              Send Message
